        ...
        <div class="container">
          <nav class="col-lg-12">
            <div class="nav_options row">
              <img
                class="small_icon"
                :src="require('@/assets/images/options.svg')"
              />
            ...
            <div class="nav_login row">
              <router-link :to="'adminchats'">
                <div>
                  <img
                    class="small_icon"
                    :src="require('@/assets/images/nav_login_icon.svg')"
                  />
                  <h5>6</h5>
                </div>
              </router-link>
            ...
            >
            <p>Выйти</p>-->
              <button  @click="AdminLogout" class="log_out_btn">
                <img
                  class="small_icon"
        ...
        <div class="container">
          <div class="col-lg-4 side_bar_container">
            <div class="profile_container row">
              ...
              <p class="col-lg-6">
                {{ $auth.getUser().firstname + " " + $auth.getUser().lastname }}
                <span v-if="$auth.getUser().roles[0].name === 'ADMIN'"
                  >Администратор</span
                >
                <span v-if="$auth.getUser().roles[0].name === 'MANAGER'"
                  >Модератор</span
                >
              </p>
            </div>
            <div class="side_bar">
              <ul>
                ...
                <router-link
                  v-bind:class="{
                    'router-link-exact-active': activeUsersClass
                  }"
                ...
                <router-link :to="'/administration/Subcategory_promotion'">
                  <li>Продвижение</li>
                </router-link>
                <router-link :to="'/administration/video_content'">
                  <li>Видео</li>
                </router-link>
                <router-link :to="'/administration/add_country_city'">
                  <li>Страны/Города</li>
                </router-link>
                <router-link :to="'/administration/good_settings'">
                  <li>Управление</li>
                </router-link>
              </ul>
            </div>
