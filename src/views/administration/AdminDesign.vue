    ...
    <div class="modal" id="myModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <input v-model="text_on_baners" placeholder="Текст описание под баннером" type="text">
          <!-- Modal footer -->
...
export default {
  ...
  methods: {
    ...
    addImage() {
      ...
      data.append('text_on_baners', this.text_on_baners);
      this.$axios
