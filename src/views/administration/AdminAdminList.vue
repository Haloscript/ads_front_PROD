  ...
  <div>
    <div class="content_container col-lg-8">
      <div class="content_label">
        <h4>Администрация</h4>
        <router-link
          :to="{ path: '/administration/addadmin/' }"
          ...
          <table class="content_tabs_table_row">
            ...
            <tr v-for="admin in allAdmins.users" :key="admin.id">
              ...
              <td style="text-align: center;">
                {{ moment(admin.createdAt).format("DD.MM.YY") }}
              </td>
              <td
                v-if="admin.roles[0].name === 'ADMIN'"
                style="text-align: center;"
              >
                Админ
              </td>
              <td
                v-if="admin.roles[0].name === 'MANAGER'"
                style="text-align: center;"
              >
                Менеджер
              </td>
              <td style="text-align: center;">
                <router-link
                  :to="{ path: '/administration/updateadmin/' + admin.id }"
