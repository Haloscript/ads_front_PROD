  ...
  <div>
    <div class="content_container col-lg-8">
      <div class="content_label">
        <h4
          v-if="
            $route.path === '/administration/updateadmin/' + $route.params.id
          "
        >
          Редактировать модератора
        </h4>
        <h4 v-if="$route.path === '/administration/addadmin/'">
          Добавить модератора
        </h4>
      </div>
        ...
        <div>
          <ul>
            <li
              v-if="
                $route.path ===
                  '/administration/updateadmin/' + $route.params.id
              "
            >
              <div>
                <avatar
            ...
            <li>
              ...
              <input  v-validate="'required|min:8'" v-model="password" type="password" name="Пароль" />
            </li>
