      ...
      <div class="content_tabs_table">
        ...
        <table class="content_tabs_table_row">
          ...
          >
            ...
            <td v-if="subcategory && subcategory.categories.length > 0 && subcategory.categories[0].groups.length >0" style="text-align: left;">
              {{ subcategory.name }} > {{ subcategory.categories[0].name }} >
              {{ subcategory.categories[0].groups[0].name }}
            </td>
